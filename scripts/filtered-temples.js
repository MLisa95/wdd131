...
const temples = [
    ...
    },
    {
        ...
        area: 119619,
        imageUrl:
        "https://churchofjesuschristtemples.org/assets/img/temples/logan-utah-temple/logan-utah-temple-47238-thumb.jpg" 
    },
...
function displayTemples(templesArray) {
  ...
  // clear function: clears section before adding filtered content
  // prevents duplicate cards from stacking up
...
function filterTemples(criteria) {
    ...
    // "filtered" = variable
    // will hold filtered list of temples depending on criteria
    let filtered;

    switch (criteria) {
        case "old":
            filtered = temples.filter((temple) => {
                const year = parseInt(temple.dedicated.split(",")[0]); // remember it was a string, convert to number parseInt
                return year < 1900;
            });
            break;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // event listeners calling filter logic according to button description
